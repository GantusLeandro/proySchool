...
<table class="table ">
    <form action="../actualizar-form.php" method="POST">
  <thead>
  <tr>
  <th scope="col"></th>
  ...
  <tbody>
    <tr>
        <td scope="row"><input name="id_pregunta" value=<?php echo $id?>></td>
        ...
        <td><input type="text" name="pregunta" value="<?php echo $mostrar['pregunta']?>"></td>
        <td><input type="text" name="respuesta_correcta" value="<?php echo $mostrar['respuesta_correcta']?>"></td>
        <td><input type="text" name="respuesta_1" value="<?php echo $mostrar['respuesta_1']?>"></td>
        <td><input type="text" name="respuesta_2" value="<?php echo $mostrar['respuesta_2']?>"></td>
        <td><input type="text" name="respuesta_3" value="<?php echo $mostrar['respuesta_3']?>"></td>
        <td><input type="text" name="respuesta_4" value="<?php echo $mostrar['respuesta_4']?>"></td>
