...
<head>
    ...
    <meta class="description" content="d" >
...
<div class="container-form">
        ...
        <div class="logo-title">
            ...
            <div class="menu">
                <a href="admin-login.php"><li class="module-register active">Admin mode</li></a>
            </div>
        </div>
        
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" class="form">
            <div class="welcome-form"><h1>Bienvenido al</h1><h2>Modo Admin</h2></div>
            <div class="user line-input">
                <label class="lnr lnr-user"></label>
                <input type="text" placeholder="Nombre Adminstrador" name="usuario">
            </div>
